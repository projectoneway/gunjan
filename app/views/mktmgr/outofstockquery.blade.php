...
<div class="container">
        <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
         ...
         <div class="form-group">
            <label for="inputPassword" class="control-label col-sm-8">Date Scanned</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="datescanned" placeholder="Date Scanned" name="datescanned">
                 @if($errors->has('datescanned'))
            {{ $errors->first('datescanned')}}
            @endif
            </div>
        </div>        
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="skunumber" placeholder="Sku Number" name="skunumber">
                 @if($errors->has('skunumber'))
            {{ $errors->first('skunumber')}}
            @endif
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="gldeptnumber" placeholder="GL Department Number" 
                       name="gldeptnumber">
