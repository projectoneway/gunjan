...
<div class="container">
        <div id="loginbox" style="margin-top:-20px" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
            <div class="panel panel-info" >
                    <div class="panel-heading" style="background-color:#CCC; color:#FFF; text-align:center; font-weight:bold;">
                        <div class="panel-title" >Offline Report</div>
                       </div> 

                 <div  class="panel-body" style="margin-top:10px" >

            
                <form action="{{URL::route('mktmgr-post-report-offlinereport')}}" class="form-horizontal" method="post" role="form" style="display: block;">
       ...
       <!--  <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" id="copies" placeholder="" name="copies">
