...
<div class="container">
    	  <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
            ...
            <label for="inputPassword" class="control-label col-sm-8">Please enter the Game number</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="gamenumber" placeholder="" name="gamenumber">
                 @if($errors->has('gamenumber'))
            {{ $errors->first('gamenumber')}}
            @endif
            </div>
        </div>					
        <div class="form-group">
