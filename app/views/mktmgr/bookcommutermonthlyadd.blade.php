...
<div class="container">
    	  <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
            <div class="panel panel-info" >
                    <div class="panel-heading" style="background-color:#CCC; color:#FFF; text-align:center; font-weight:bold;">
                        <div class="panel-title" >MONTHLY COMMUTER INVENTORY</div>
                       </div> 
            ...
            <label for="inputPassword" class="control-label col-sm-8">Please enter the Inventory Type</label>
            <div class="col-sm-10">
         ...
         <div class="form-group">
            <label for="inputPassword" class="control-label col-sm-8">Please enter the Description</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="dateofinfo" placeholder="" name="dateofinfo">
                 @if($errors->has('dateofinfo'))
            {{ $errors->first('dateofinfo')}}
        ...
        <div class="form-group">
            <label for="inputPassword" class="control-label col-sm-8">Please enter the Month</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="dateofinfo" placeholder="" name="dateofinfo">
                 @if($errors->has('dateofinfo'))
            {{ $errors->first('dateofinfo')}}
